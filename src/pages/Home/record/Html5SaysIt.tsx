...
export const Html5SaysIt: FC = () =>
  <Moment year="2014"
    ...
    <a className="signpost" href="https://html.com/html5/">“in a lot of different contexts — desktops, laptops, tablets, mobile phones, RSS readers”</a>,
    ...
    adopting what is{' '}
    <a className="signpost" href="https://www.infoq.com/news/2011/05/html5-design/">“widely accepted”</a> instead of inventing anew; degrade
    gracefully; and priority of constituencies, the cascade’s settlement written into the
    constitution:{' '}
    <a className="signpost" href="https://www.infoq.com/news/2011/05/html5-design/">“users &gt; authors &gt; implementors &gt; specifiers &gt; theoretical purity”</a>.</p>
    ...
    <a className="signpost" href="https://www.infoq.com/news/2011/05/html5-design/">“a nestable &lt;SECTION&gt;..&lt;/SECTION&gt; element”</a>
