...
export const BlurReturns: FC = () =>
  <Moment year="2013"
          ...
          tells={<>The single-page application moved the whole document into script: the server
            ...
            style ran through one language again, and the old costs returned in new clothes.</>}>
    ...
    shipped for twenty years, each one a solved problem reopened.</p>
  </Moment>;
