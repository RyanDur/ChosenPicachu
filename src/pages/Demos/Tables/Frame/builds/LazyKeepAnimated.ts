...
import {Moving, lazyTravel, pointerTravel, still} from '@components/DragSortableTable/travel';
...
import {
  Carry, Landed, MeasuresState, MountedTable, carriedOffset, carrying, changed, columnOf, columnLandingAt, demosStore, feedRequested, moveReport, orderOf, orderedTo, released, reset, rowLandingAt, rowLifted, rowNudgedTo, ruledBy, seatedTo, selectMeasures, selectStanding, sortsOf, tableOf, tableStore, widthsShown
