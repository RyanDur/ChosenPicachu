...
export const orderInState = (tableSource: string) =>
...
export const liftOnce = (hookSource: string, tableSource: string) =>
...
export const dragSurface = (hookSource: string) =>
...
export const ghostByHand = (hookSource: string) =>
...
export const theaterVertical = (tableSource: string) =>
...
export const focusLands = (headerSource: string) =>
...
export const arrowsSpeak = (headerSource: string) =>
