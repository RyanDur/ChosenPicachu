  ...
  <section aria-label="banner controls" className="controls">
    <article className="control">
      ...
      <PillGlider label="side"
                  ...
                  chosen={side}
                  onChoose={onSide}/>
      <p className="reading">{copy.side[side]}</p>
    </article>
    <article className="control">
      <span className="axis">align</span>
      <PillGlider label="align"
                  ...
                  chosen={align}
                  onChoose={onAlign}/>
      <p className="reading">{copy.align[align]}</p>
    </article>
    <article className="control">
      <span className="axis">entrance</span>
      <PillGlider label="entrance"
                  ...
                  chosen={enter}
                  onChoose={onEnter}/>
      <p className="reading">{copy.enter[enter]}</p>
    </article>
    <article className="control">
      <span className="axis">stack</span>
      <PillGlider label="stack"
                  ...
                  chosen={stack}
                  onChoose={onStack}/>
      <p className="reading">{copy.stack[stack]}</p>
    </article>
    <p className="readout">
