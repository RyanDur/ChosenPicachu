...
export const NaturalZIndex: FC<PropsWithClassName> = ({className}) => {
  ...
  return <article id="z-index-demo" className={className}>
    ...
    <section className='demo-container'>
      <p className={classNames('layer white rounded-corners raised', isCollapsed && 'closed')}>First</p>
      <p className={classNames('layer white rounded-corners raised', isCollapsed && 'closed')}>Second</p>
      <p className={classNames('layer white rounded-corners raised', isCollapsed && 'closed')}>Third</p>
    </section>
  </article>;
};