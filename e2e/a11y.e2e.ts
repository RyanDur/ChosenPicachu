...
const pages: A11yPage[] = [
  ...
  {name: 'menu tutorial', path: 'demos?tab=tables&tut=menu', ready: 'navigation', loaded: '.build-steps .snippet:visible'},
  {name: 'resize tutorial', path: 'demos?tab=tables&tut=resize', ready: 'navigation', loaded: '.build-steps .snippet:visible'},
